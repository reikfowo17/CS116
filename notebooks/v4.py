...
# Recency weighting: linear up-weighting of recent observations
...
def solve_horizon(horizon):
    ...
    # ── Prepare native categorical columns ──────────────────────────────────
    ...
    # Re-run a quick probe just for importance (no early stopping needed here)
    ...
    # Linear recency weighting: recency from 0.5 to ~43 across ts_index range
